...
public class GameTestP2 {
	...
	public void testNextPiece2() throws TetrisException {
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/nextpiece2.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/nextpiece2.sol");
	...
	public void testNextPiece3() throws TetrisException{
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/nextpiece3.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/nextpiece3.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());			
	}
	...
	public void testNextPiece4() throws TetrisException {
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/nextpiece4.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/nextpiece4.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	}
	...
	public void testMovimentsInPieceFixed() throws TetrisException {
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movementsinpiecefixed.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movementsinpiecefixed.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	}
	...
	public void testMovimentsInGameEnded() throws TetrisException {
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movementsingameended.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movementsingameended.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	}
	...
	public void testMoveCurrentPieceLeft1() throws TetrisException {
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpieceleft1.alu");
		saveGame(gameMiniTest);
		assertTrue(gameMiniTest.nextPiece("I"));
		saveGame(gameMiniTest);
		gameMiniTest.rotateCurrentPieceCounterclockwise();
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpieceleft1.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	...
	public void testMoveCurrentPieceLeft2() throws TetrisException {
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpieceleft2.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpieceleft2.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	}
	...
	public void testMoveCurrentPieceRight1() throws TetrisException {
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpieceright1.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpieceright1.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	...
	public void testMoveCurrentPieceRight2() throws TetrisException {
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpieceright2.alu");
		//Probamos ahora con una nueva pieza
		saveGame(gameMiniTest);
		gameMiniTest.nextPiece("I");
		saveGame(gameMiniTest);
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpieceright2.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	}
	...
	public void testMoveCurrentPieceDown1() throws TetrisException {
		 ...
		 */
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpiecedown1.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpiecedown1.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	}
	...
	public void testMoveCurrentPieceDown2() throws TetrisException {
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpiecedown2.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpiecedown2.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());	
	}
	...
	public void testMoveCurrentPieceDown3() throws TetrisException {
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/movecurrentpiecedown3.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/movecurrentpiecedown3.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	}
	...
	public void testRotateClockwise() throws TetrisException{
		...
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/rotateclockwise.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/rotateclockwise.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	}
	...
	//Rotamos continuamente una pieza  y la bajamos hasta el final del tablero
		...
		public void testRotateCounterclockwise() throws TetrisException {
			...
			ps = openFileForWritingStudentOutput("testsP2Corrector/files/rotatecounterclockwise.alu");
			...
			sbIn=readSolutionFromFile("testsP2Corrector/files/rotatecounterclockwise.sol");
			assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
		}
	...
	public void testMainP2() throws TetrisException {
		...
		Game game= new Game(new Coordinate(7, 10));
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/mainP2.alu");
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/mainP2.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	}
	...
	public void testPartida1() throws TetrisException {
		...
		Game game= new Game(new Coordinate(7, 10));
		ps = openFileForWritingStudentOutput("testsP2Corrector/files/partida1.alu");
		saveGame(game);
		...
		sbIn=readSolutionFromFile("testsP2Corrector/files/partida1.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	}
