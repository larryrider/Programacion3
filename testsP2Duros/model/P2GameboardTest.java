...
public class P2GameboardTest {
	...
	public void ValidPlaceTest() {
		...
		assertTrue(validExpected == gameboard.isPlaceValid(
				new Coordinate(0, 0), PieceFactory.createPiece("I")));
		assertTrue(validExpected == gameboard.isPlaceValid(
				new Coordinate(-1, 0), PieceFactory.createPiece("I")));
		assertFalse(validExpected == gameboard.isPlaceValid(new Coordinate(-5,
				5), PieceFactory.createPiece("I")));
		assertFalse(validExpected == gameboard.isPlaceValid(new Coordinate(0,
				-1), PieceFactory.createPiece("I")));
		assertFalse(validExpected == gameboard.isPlaceValid(new Coordinate(0,
				10), PieceFactory.createPiece("I")));
		assertFalse(validExpected == gameboard.isPlaceValid(new Coordinate(10,
				0), PieceFactory.createPiece("I")));
		assertFalse(validExpected == gameboard.isPlaceValid(new Coordinate(10,
				10), PieceFactory.createPiece("I")));
		// assertFalse(validExpected == gameboard.isPlaceValid(null, new
		// Piece()));
		// assertFalse(validExpected == gameboard.isPlaceValid(new
		// Coordinate(0,0), null));
	...
	public void FreePlaceTest() {
		...
		assertTrue(freeExpected == gameboard.isPlaceFree(new Coordinate(0, 0),
				dummy));
		assertTrue(freeExpected == gameboard.isPlaceFree(new Coordinate(3, 0),
				dummy));
		
		// AQUI AÑADO YO LO DE FIJAR LA PIEZA DUMMY
		dummy.setFixed(true);
		assertFalse(freeExpected == gameboard.isPlaceFree(new Coordinate(0, 0),
				toTest));
	}
