...
public class GameTestP3 {
	...
	public void testMoveCurrentPieceDown1() {
		ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown1.alu");
		...
		sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown1.sol");
	...
	public void testMoveCurrentPieceDown2() {
		ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown2.alu");
		Gameboard gb = game.getGameboard();
		...
		sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown2.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testMoveCurrentPieceDown3() {
			ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown3.alu");
			...
			sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown3.sol");
			assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testMoveCurrentPieceDown4() {
			ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown4.alu");
			Gameboard gb = game.getGameboard();
			prepareGameboard(game);
			...
			sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown4.sol");
			assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testMoveCurrentPieceDown5() {
			ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown5.alu");
			Gameboard gb = game.getGameboard();
			prepareGameboard(game);
			gb.setCellContent(new Coordinate(7,0),p[4]);
			gb.setCellContent(new Coordinate(6,1), p[3]);
			...
			sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown5.sol");
			assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testMoveCurrentPieceDown6() {
			ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown6.alu");
			Gameboard gb = game.getGameboard();
			prepareGameboard(game);
			...
			sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown6.sol");
			assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testMoveCurrentPieceDown7() {
			ps = openFileForWritingStudentOutput("testsP3Corrector/files//testMoveCurrentPieceDown7.alu");
			Gameboard gb = game.getGameboard();
			prepareGameboard(game);
			gb.setCellContent(new Coordinate(5,2),p[4]);
			gb.setCellContent(new Coordinate(6,1), p[3]);
			...
			sbIn=readSolutionFromFile("testsP3Corrector/files//testMoveCurrentPieceDown7.sol");
			assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testPartida1() {
		ps = openFileForWritingStudentOutput("testsP3Corrector/files//testPartida1.alu");
		try {
			saveGame(game);
			game.nextPiece("J");
			saveGame(game);
		...
		sbIn=readSolutionFromFile("testsP3Corrector/files//testPartida1.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	
	}
	@Test
	public void testPartida2() {
		ps = openFileForWritingStudentOutput("testsP3Corrector/files//testPartida2.alu");
		Gameboard gb = game.getGameboard();
		...
		sbIn=readSolutionFromFile("testsP3Corrector/files//testPartida2.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testPartida3() {
		ps = openFileForWritingStudentOutput("testsP3Corrector/files//testPartida3.alu");
		Gameboard gb = game.getGameboard();
		Piece p = PieceFactory.createPiece("O");
		p.setFixed(true);
		...
		sbIn=readSolutionFromFile("testsP3Corrector/files//testPartida3.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
	...
	public void testPartida4() {
		ps = openFileForWritingStudentOutput("testsP3Corrector/files//testPartida4.alu");
		Gameboard gb = game.getGameboard();
		Piece p = PieceFactory.createPiece("O");
		p.setFixed(true);
		...
		sbIn=readSolutionFromFile("testsP3Corrector/files//testPartida4.sol");
		assertEquals("solucion == alumno",sbIn.toString().trim(),sbOut.toString().trim());
