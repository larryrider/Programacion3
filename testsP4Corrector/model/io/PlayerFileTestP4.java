...
public class PlayerFileTestP4 {
	...
	public void testNextMove() {
		NewPlayerFile("testsP4Corrector/files/P4/testNextMove.in");
	...
	public void testNextMoveConEspacios() {
		NewPlayerFile("testsP4Corrector/files/P4/testNextMoveConEspacios.in");
	...
	public void testNextMoveIOException1() {
		NewPlayerFile("testsP4Corrector/files/P4/testNextMoveIOException1.in");
		char c=' ';
		try {
	...
	public void testNextMoveIOException2() {
		NewPlayerFile("testsP4Corrector/files/P4/testNextMoveIOException2.in");
		char c=' ';
		try {
			for (int i=0; i<m2.length(); i++) {
				c =pf.nextMove();
	...
	public void testNextMoveIOException3() {
		NewPlayerFile("testsP4Corrector/files/P4/testNextMoveIOException3.in");
		char c=' ';
		try {
			for (int i=0; i<m2.length(); i++) {
				c =pf.nextMove();
	...
	public void testNextMoveIOException4() {
		NewPlayerFile("testsP4Corrector/files/P4/testNextMoveIOException4.in");
		char c=' ';
		try {
			for (int i=0; i<m2.length(); i++) {
				c =pf.nextMove();
